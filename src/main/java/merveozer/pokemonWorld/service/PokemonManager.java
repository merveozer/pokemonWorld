...
import merveozer.pokemonWorld.communication.PokemonConsumer;
...
public class PokemonManager implements PokemonService {
    ...
    private PokemonEventPublisher pokemonEventPublisher;
    ...
    public Result add(Pokemon pokemon) throws Exception {
        try {
            ...
            String message = "Pokemon was added successfully " + pokemon.getPokemonName();
            pokemonEventPublisher.publishEvent(EventType.CREATE, KafkaTopic.POKEMON_ADDED, message);
